...
![rpi-connect on を忘れて signin が失敗するログ](/images/openclaw-03/01-not-running-error.png)
...
![TigerVNC の接続ダイアログに 100.72.229.19:5900 を入力](/images/openclaw-03/05-tigervnc-connect-dialog.png)
